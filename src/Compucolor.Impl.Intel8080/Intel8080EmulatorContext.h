...
namespace Compucolor::Impl::Intel8080
{
    class Intel8080EmulatorContext {
        public:
            ...
            void SetBus(std::shared_ptr<Compucolor::Intel8080::IIntel8080Bus> intel8080Bus);
    
            std::optional<std::shared_ptr<Compucolor::Memory::IMemory>> GetMemory();
            std::optional<std::shared_ptr<Compucolor::Intel8080::IIntel8080Bus>> GetBus();
    
        private:
            std::optional<std::shared_ptr<Compucolor::Intel8080::IIntel8080Bus>> _bus;
