...
Compucolor::Impl::Configuration::Configuration::Configuration(
...
void Compucolor::Impl::Configuration::Configuration::LoadFile(std::string filename)
{
    _logger->LogTrace(
...
std::optional<std::string> Compucolor::Impl::Configuration::Configuration::GetSetting(std::string key)
{
    if(_data.count(key))
    {
